...
class Ingredients extends StatelessWidget {
  ...
  const Ingredients(this.imageUrl, this.name, this.allergens, this.ingredients,
      {Key? key})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    final userAllergens = Provider.of<DataProvider>(context)
        ...
        .toList();
    bool isSafeForUser = allergens == null ||
        allergens!.isEmpty ||
        !allergens!.any((allergen) => userAllergens.contains(allergen));
          ...
          children: [
            ...
            if (isSafeForUser)
              ...
              ...allergens!.map((allergen) => Card(
                    ...
                    child: ListTile(
                      leading: Icon(
                        userAllergens.contains(allergen)
                            ? Icons.warning
                            : Icons.info,
                        color: userAllergens.contains(allergen)
                            ? Colors.redAccent
                            : Colors.yellowAccent,
                      ),
                      title: Text(
